...
android {
    namespace = "nl.ahmed.features.details.shared"
...
dependencies {
    ...
    // Favorites
    implementation(project(":features:details:ui"))
    implementation(project(":features:details:presentation:api"))
    implementation(project(":features:details:presentation:implementation"))
    implementation(project(":features:details:domain:api"))
    implementation(project(":features:details:domain:implementation"))
